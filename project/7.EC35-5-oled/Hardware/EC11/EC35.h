...
#define EC35_A_PIN  			GPIO_Pin_6
#define EC35_B_PIN  			GPIO_Pin_5
					
#define EC35_EXTI_A_RCC     GPIO_PortSourceGPIOC
#define EC35_EXTI_A_PIN     GPIO_PinSource6
					
#define EC35_EXTI_B__RCC     GPIO_PortSourceGPIOC
#define EC35_EXTI_B_PIN      GPIO_PinSource5

#define EC35_A_EXTI_Line    EXTI_Line6         //中断线选择
#define EC35_B_EXTI_Line    EXTI_Line5         //中断线选择
