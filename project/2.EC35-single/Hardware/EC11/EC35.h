...
#define EC35_A_PIN  			GPIO_Pin_7
#define EC35_B_PIN  			GPIO_Pin_8
					
#define EC35_EXTI_A_RCC     GPIO_PortSourceGPIOC
#define EC35_EXTI_A_PIN     GPIO_PinSource7
					
#define EC35_EXTI_B__RCC     GPIO_PortSourceGPIOC
#define EC35_EXTI_B_PIN      GPIO_PinSource8

#define EC35_A_EXTI_Line    EXTI_Line7         //中断线选择
#define EC35_B_EXTI_Line    EXTI_Line8         //中断线选择
